...
S13360_6025CS_6x6::S13360_6025CS_6x6() : AbsMPPC() {
...
S13360_6025CS_6x6::~S13360_6025CS_6x6() {
  // TODO Auto-generated destructor stub
}

G4String S13360_6025CS_6x6::getName() {
  return "S13360-6025CS-6x6";
}

G4double S13360_6025CS_6x6::getXYSize() {
  return 6 * 6 * mm;
}

G4double S13360_6025CS_6x6::getZSize() {
  return 20 * mm; // original 2*mm, increased to see photon tracks terminated
}

G4double S13360_6025CS_6x6::getWindowThickness() {
  return 0.45 * mm;
}

G4double S13360_6025CS_6x6::getCathodeThickness() {
  return getZSize() - getWindowThickness();
}

G4Material* S13360_6025CS_6x6::getWindowMaterial() {
  return Materials::getInstance()->getMaterial("silicone-resin");
}

G4Material* S13360_6025CS_6x6::getCathodeMaterial() {
